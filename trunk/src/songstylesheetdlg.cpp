...
wxPanel* SongStyleSheetDlg::CreatePageSetupPage(wxWindow* parent)
{
    ...
    wxBoxSizer* pageStaticBoxSizer = new wxStaticBoxSizer(pageStaticBox, wxVERTICAL );
    item0->Add(pageStaticBoxSizer, 0, wxGROW|wxALL, 5);

    wxGridSizer* pageSizer = new wxGridSizer(2, 2, 4, 4);
	pageSizer->Add(new wxStaticText(panel, wxID_ANY, _("Width:")));
	pageSizer->Add(new wxTextCtrl(panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(60, wxDefaultCoord), 0, wxTextValidator(wxFILTER_NUMERIC, &m_pageWidth)));
	//pageSizer->Add(new wxTextCtrl(panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(60, wxDefaultCoord), 0, wxTextValidator(wxFILTER_ALPHA, &m_pageWidth)));

	pageSizer->Add(new wxStaticText(panel, wxID_ANY, _("Height:")));
	pageSizer->Add(new wxTextCtrl(panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(60, wxDefaultCoord), 0, wxTextValidator(wxFILTER_NUMERIC, &m_pageHeight)));
    pageStaticBoxSizer->Add(pageSizer, 0, wxALL, 3);
    pageSizer->Add(new wxStaticText(panel, wxID_ANY, _("Orientation:")));
